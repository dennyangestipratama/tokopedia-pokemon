   ...
   return (
      <Fragment>
         ...
         <div className={home_page}>
            <button className={button} disabled={page === 1} onClick={() => prevPage()}>Previous</button>
            <span>{page}</span>
            <button className={button} disabled={offset === data.pokemons.count - 12} onClick={() => nextPage()}>Next</button>
         </div>
      </Fragment>
   )
}
